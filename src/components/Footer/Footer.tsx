...
// أيقونة Send بسيطة بـ SVG عشان الـ Newsletter
const SendIcon = () => (
                    ...
                    <div className="main-footer">
                        <div className="col info-col">
                            ...
                            <div className="social">
                                ...
                                {/* WhatsApp - Real Logo with Colors */}
                                <a href="https://wa.me/201234567890" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer" className="whatsapp-link">
                                    <Image
                                        src="/icons/whatsApp.svg" // تأكد من وجود الملف بالألوان في هذا المسار
                                        alt="WhatsApp"
                                        width={22} // كبرناها سنة عشان اللوجو الملون بيبان أصغر
                                        height={22}
